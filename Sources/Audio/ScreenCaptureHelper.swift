...
public final class ScreenCaptureHelper {
    ...
    public func requestPermissionsIfNeeded() -> Bool {
    ...
    public func captureVisibleScreen(outputPath: String = "/tmp/jev_screen.png") async throws -> String {
        ...
        guard let display = content.displays.first else {
            throw NSError(domain: "ScreenCaptureHelper", code: 404, userInfo: [NSLocalizedDescriptionKey: "No active display found"])
        }
